...
<?php
      ...
      if(!$classes) {
        ...
        foreach($classes as $uid) {
          $node = $n->getObjectByUid($uid) or die("No such record");
          $code = $node->getCode();
          $year = $node->getYear();
          $numClasses = $node->getDays();
          $link = 'take.php?cN='.$uid;
        ...
        <div class="modal-content">
          ...
          <hr>
            <div id="add_class_form">
              ...
              <input class="form-control" name="code" placeholder="Code , Eg : ICS212">
              ...
              <button class="btn" id="cancel" onclick="$('.bs-example-modal-lg').modal('hide');">Cancel</button>
            </div>
        </div>
    </div>

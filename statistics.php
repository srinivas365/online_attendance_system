    ...
    <div class="wrapper">
    	...
    	if($classes!=0){
    		...
    		foreach ($classes as $c) {
    			# code...
    			$node=$n->getObjectByUid($c) or die("NO such record");
    			$key=$node->getCode().'( '.$node->getYear().' )';
    		...
    		<li class="active"><a href="#detained">short Attendance</a></li>
    		</ul>
    		<div class="content">
    		<div id="graph">
    		</div>
